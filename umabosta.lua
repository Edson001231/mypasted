...
if game.CoreGui:FindFirstChild("SysBroker") then
	game:GetService("StarterGui"):SetCore("SendNotification", {Title = "pastedware",Text = "pasted and nigga",Duration = 5;})
	return
end
local version = 2
--VARIABLES
...
FlingTarget_Button.Text = "niggerfucker"
...
boldAnim_Button.BackgroundColor3 = Color3.fromRGB(0, 255, 255)
...
boldAnim_Button.Position = UDim2.new(0, 210, 0, 525)
boldAnim_Button.Size = UDim2.new(0, 150, 0, 30)
boldAnim_Button.Font = Enum.Font.Oswald
boldAnim_Button.Text = "eufizessamerda"
